characters = [
{
  ...
  "damage"  : 12,
  "dmgInc"  : 12,
  "avatar"  : "assets/spidermanrsz.png.png"
},
{
  "id"      : 1,
  "name"    : "Hulk",
...
},
{
  ...
  "damage"  : 11,
  "dmgInc"  : 8,
  "avatar"  : "assets/ironmanrsz.png.png"
},
{
  "id"      : 3,
  "name"    : "Squirrel Girl",
  ...
  "damage"  : 18,
  "dmgInc"  : 5,
  "avatar"  : "assets/squirrelgirl.png.png"
}
];
...
function renderGameOver(w) {
  ...
  if(w) {
    $("#showcase h4.hp").text("WINNER BOI!");
    $("#gameOver #message").html("You defeated everyone. You win,BOI!");
  } else {
